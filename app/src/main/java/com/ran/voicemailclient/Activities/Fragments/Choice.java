        ...
        tts = new TextToSpeech(this.getContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    speak("Welcome to Voice Mail Client,"+"Your personalised Voice based Mailing Application, "+"Lets begin! Select your choice: Say compose to compose the mail, else Say Read to read the mails");
